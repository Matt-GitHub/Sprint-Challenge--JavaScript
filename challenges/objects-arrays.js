...
console.log(dinoObject[0].weight);

// What was the diet of a velociraptor?
console.log(dinoObject[2].diet);

// How long was a stegosaurus?
console.log(dinoObject[1].length);

// What time period did tyrannosaurus live in?
console.log(dinoObject[0].period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinoObject[0].Roar());
...
const universities = [];
graduates.forEach(sorted => {
  universities.sort().push(sorted.university);
})
...
const unisWithUni = universities.filter(include => include.includes('Uni'));
...
*/
const lowPopulationAnimals = zooAnimals.filter(word => {
  return word.population < 5
})
